    ...
    return (
        <div className="aboutDescription">
            <div className="verticalLineAbout">
                ...
                <div style={{fontSize: '28px', fontWeight: 700, fontFamily: "Rajdhani", color: 'white'}} className="about">{about}</div>
            </div>
...
export const TournamentDetails2 = ({ meeting }: Event2) => {
    return (
        <div className="aboutDescription">
            <div className="verticalLineAbout">
                <div className="vertical1" />
                <div style={{fontSize: '28px', fontWeight: 700, fontFamily: "Rajdhani", color: 'white'}}>{meeting}</div>
            </div>
        </div>
    )
}
